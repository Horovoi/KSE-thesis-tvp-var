...
function [ml,mlstd] = ml_var_rs(Y,store_theta,store_Sig,store_P,prior,bigX,M)

disp('Computing marginal likelihood of VAR-RS.... '); 
...
for isim = 1:M
    ...
    llike = intlike_var_rs(shortY,bigX,reshape(theta,k,r),reshape(Sig,n,r),P);
